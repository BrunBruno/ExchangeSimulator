...
public class SellOrderRequestHandlerTests
{
    ...
    [Fact]
    public async Task Handle_Throws_BadRequestException_When_Order_Type_Is_Not_Sell()
    {
        //given
        var userId = Guid.NewGuid();
        var request = new SellOrderRequest
    ...
    [Fact]
    public async Task Handle_Throws_BadRequestException_When_PlayerCoin_LockedBalance_Is_Too_Low()
    {
        //given
        var userId = Guid.NewGuid();
        var request = new SellOrderRequest
    ...
    [Fact]
    public async Task Handle_Throws_BadRequestException_When_Player_Has_Not_Enough_Money()
    {
        //given
        var userId = Guid.NewGuid();
        var request = new SellOrderRequest
