...
public class CreateBuyLimitOrderRequestHandler : IRequestHandler<CreateBuyLimitOrderRequest> {
    ...
    public async Task Handle(CreateBuyLimitOrderRequest request, CancellationToken cancellationToken) {
